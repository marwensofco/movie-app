package com.tritux.movie.movieapp.firebase;
...
public class FirebaseInitialization {
	...
	public void initialization() {
		try {
			...
			String con = "{ " + "\"type\": \"service_account\"," + "\"project_id\": \"YOUR_PROJECT_ID\","
					+ "\"private_key_id\": \"YOUR_PRIVATE_KEY_ID\","
					+ "\"private_key\": \"-----BEGIN PRIVATE KEY-----\n/4IySaJ1DcN6RvXhIjcHY=\n-----END PRIVATE KEY-----\n\","
					+ "\"client_email\": \"YOUR_CLIENT_EMAIL\"," + "\"client_id\": \"YOUR_CLIENT_ID\","
			...
			FirebaseOptions options = FirebaseOptions.builder().setCredentials(GoogleCredentials.fromStream(is))
					.build();
